...
const Region = () => {
  ...
  return (
    <div className="w-full mt-1">
      <Account />
      <div className="flex flex-col mx-10 my-24 gap-2">
        <h2
...
<h3>Select Country</h3>
          <Select
            ...
            <input type="text" placeholder="Enter Region Name" className="border border-gray-500 rounded-md mt-5 p-2" />
            </div>
        <button
        ...
        {/* {showCountry && selectedCountries.length > 0 && ( */}
          <div className="mt-4 w-screen">
            ...
            <table className="border-collapse  w-full ">
              <thead >
                <tr >
                  <th className=" border-md p-2 bg-black border-r-2 text-white rounded-l-xl">Country</th>
                  <th className="  rounded-r-xl p-2 bg-black text-white">Status</th>
                </tr>
              </thead>
              <tbody>
